        ...
        <table className="w-full">
          ...
          <tbody>
            {data?.map((item, index) => (
              <tr
                key={index}
                className="text-sm text-gray-600 border-gray-200 dark:border-gray-700 dark:text-gray-500 hover:bg-gray-300/10"
              >
                <td className="py-4">
                ...
                <td className="flex items-ceneter px-2 py-4 font-medium text-black dark:text-gray-400">
                  <span
                    className={`${
                      item?.type === "income"
                        ? "text-emerald-600"
